...
export default function RoleInput({onChange, reference}: RolesProps) {
    ...
    return (<Autocomplete onInput={onChangeRole} onChange={onChangeRole} onAbort={() => onChange('')} freeSolo
...
export function RolesInput({defRoles, onChange, reference}: RolesProps) {
